...
for(const folder of ['realism','mobile'])for(const n of ['paving','grass','wall','roof'])for(const suffix of ['diff','nor','rough'])reference('world-scene.js',`./assets/${folder}/${n}_${suffix}.jpg`,'generated-texture','document');
reference('world-scene.js','./assets/mobile/water-normal.jpg','generated-texture','document');
